...
def get_user_role_and_info(operate_account: str) -> dict:
    ...
    try:
        ...
        if res["role_name"] == "科任老师":
            ...
            if course_name_data and course_name_data["course"]:
...
def query_score(operate_account: str, target_student_id: str, target_course_id: str) -> dict:
    ...
    try:
        sql = f"""
            SELECT sc.id, sc.exam_id, e.exam_name, sc.student_id, s.student_name,
                   sc.course_id, c.course_name, sc.original_score, sc.convert_score, sc.course_rank
            FROM exam_score sc
...
def update_score(operate_account: str, score_id: int, new_original_score: float) -> dict:
    ...
    # 只有科任老师能修改成绩
    if role_name != "科任老师" or not teach_course_ids:
...
if __name__ == "__main__":
    # # 测试1：学生查自己的成绩 ✔️有权限
    # print("===== 学生S0000001查自己的语文(C101)成绩 =====")
    # print(query_score("S000001", "S000001", "C101"))

    # # 测试2：学生查别人的成绩 ❌无权限
    # print("===== 学生S000001查S000002的数学(C101)成绩 =====")
    # print(query_score("S000001", "S000002", "C101"))

    # # 测试3：科任老师修改自己授课课程的成绩 ✔️有权限
    # print("===== 科任老师T002修改成绩ID=1 =====")
    # print(update_score("T000002", 1, 98.5))

    # # 测试4：校长尝试修改成绩 ❌无权限
    # print("===== 校长X001修改成绩ID=1 =====")
    # print(update_score("X001", 1, 99.0))
    
    # 测试5：校长修改职工信息 ✔️有权限
    print(update_staff_info_api("T000001", "T000002", position="教务主任", course="NULL"))
    # 测试6：其他人修改职工信息 ❌无权限
